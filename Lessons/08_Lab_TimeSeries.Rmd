...
BR_rain_ts <- ts(BR_complete$Rainfall, start=c(1901,01), frequency=12)
BR_temp_ts <- ts(BR_complete$Temperature_C, start=c(1901,01), frequency=12)

#more general if not easy to find earliest data
...
BR_rain_components <- 
  mutate(BR_rain_components, Observed=BR_complete$Rainfall, Date=BR_complete$Date)

BR_temp_components <-
  mutate(BR_temp_components, Observed=BR_complete$Temperature_C, Date=BR_complete$Date)
